...
confusionMatrix(p2, rf.test$quality )
```
The accuracy is roughly 68.24% when utilizing the test dataset with the new random forest model. This is a .7% improvement from the previous results of 68.91%.
