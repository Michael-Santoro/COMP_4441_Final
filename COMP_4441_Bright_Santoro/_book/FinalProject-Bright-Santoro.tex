...
The dataset utilized for our analysis was collected from the UCI Machine Learning Repository \protect\hyperlink{ref-model_wine}{P. Cortez and Reis.} (\protect\hyperlink{ref-model_wine}{2009}). The dataset consists of 12 elements, 11 physiochemical properties and 1 subjective quality measurement, for both red and white Vinho Verde wine samples from Portugal.
